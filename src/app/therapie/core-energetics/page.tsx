    ...
    <div className="min-h-screen bg-white">
      <main className="mx-auto max-w-7xl px-4 py-10 sm:py-14">
        <LandingHero
          ...
          subtitle={<span>Tiefenpsychologische Körpertherapie nach John Pierrakos – Körper, Emotionen und spirituelle Dimension integrieren</span>}
          formDataCta="core-energetics-page-signup"
        />
        ...
        <RelatedTreatments currentSlug="core-energetics" />
