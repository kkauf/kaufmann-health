...
// Backward-compat alias for old email image URLs
// Old: /api/images/therapist-profiles/<path>
// New: /api/public/images/therapist-profiles/<path>
// We proxy directly to Supabase public storage to avoid an extra internal hop
