...
/**
 * Classic contact form for A/B test (control variant).
 *
 * Full contact collection: name + email/phone toggle + consent + trust badges.
 * Snapshot of main:Screen1.tsx minus isConcierge prop.
 * Delete this file when the A/B test concludes and a winner is chosen.
 */
...
import type { Screen1Values, ContactMethod } from './Screen1';
...
export default function ScreenContactClassic({
  values,
  onChange,
  onNext,
  onBack,
