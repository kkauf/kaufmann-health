...
export function renderTherapistReminder(params: {
  ...
  lines.push('<p style="margin:0 0 20px; font-size:16px; line-height:1.65; color:#475569 !important;">Dein Profil ist fast startklar – es fehlen nur noch wenige Angaben.</p>');

  lines.push('<div style="background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%) !important; background-image: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%) !important; padding:20px 24px; border-radius:12px; border:1px solid rgba(251, 191, 36, 0.3); margin: 20px 0; box-shadow: 0 2px 4px 0 rgba(251, 191, 36, 0.1);">');
  lines.push(`<p style=\"margin:0 0 12px; color:#78350f !important; font-size:17px; font-weight:700;\">Fehlende Angaben:</p>`);
  lines.push(`<p style=\"margin:0; color:#78350f !important; font-size:15px; line-height:1.65;\">${escapeHtml(missingList)}</p>`);
  ...
  lines.push('<p style="margin:0 0 16px; font-size:16px; line-height:1.65; color:#475569 !important;">Dauert nur 5–10 Minuten. Danach kannst du sofort Klienten‑Anfragen erhalten.</p>');
  ...
  if (params.optOutUrl) {
    ...
    lines.push(
      `<p style=\"margin:0; color:#64748b !important; font-size:14px; line-height:1.6;\">Möchtest du diese Erinnerungen pausieren? <a href=\"${escapeHtml(params.optOutUrl)}\" style=\"color:#10b981 !important; text-decoration:none; font-weight:600;\">Hier klicken</a>.</p>`
    );
    lines.push('</div>');
  }
