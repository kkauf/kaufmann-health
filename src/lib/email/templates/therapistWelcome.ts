...
export function renderTherapistWelcome(params: {
  ...
  const contentHtml = `
    ...
    <p style="margin:0 0 16px; font-size:16px; line-height:1.65; color:#475569 !important;">vielen Dank für deine Anmeldung bei Kaufmann Health!</p>
    <div style="background: linear-gradient(135deg, #ecfdf5 0%, #d1fae5 100%) !important; background-image: linear-gradient(135deg, #ecfdf5 0%, #d1fae5 100%) !important; padding:16px 20px; border-radius:12px; border:1px solid rgba(16, 185, 129, 0.3); margin:0 0 20px; box-shadow: 0 2px 4px 0 rgba(16, 185, 129, 0.1);">
      <p style="margin:0; font-size:16px; line-height:1.65; color:#064e3b !important; font-weight:600;">${escapeHtml(leadStatusMessage)}</p>
    </div>
    ...
    <div style="background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%) !important; background-image: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%) !important; padding:20px 24px; border-radius:12px; border:1px solid rgba(226, 232, 240, 0.8); margin: 20px 0; box-shadow: 0 2px 4px 0 rgba(100, 116, 139, 0.05);">
      <h3 style="margin:0 0 16px; color:#0f172a !important; font-size:18px; font-weight:700;">Was wir benötigen</h3>
      ...
      <p style="margin:16px 0 0; color:#475569 !important; font-size:15px; line-height:1.65;">Alles in einem Schritt – dauert nur 5–10 Minuten. Wir prüfen innerhalb von 2 Werktagen.</p>
    </div>

    <div style="margin: 16px 0 0; padding:16px 20px; border:1px solid rgba(226, 232, 240, 0.8); border-radius:12px; background:#ffffff !important; box-shadow: 0 2px 4px 0 rgba(100, 116, 139, 0.05);">
      <div style="font-weight:700; color:#0f172a !important; margin-bottom:8px; font-size:15px;">Vertragsdokumente</div>
      <div style="color:#475569 !important; font-size:15px; line-height:1.65;">Du hast Version <strong style="color:#0f172a !important;">${escapeHtml(params.termsVersion)}</strong> akzeptiert.</div>
      <div style="margin-top:10px;"><a href="${termsUrl}" style="color:#10b981 !important; text-decoration:none; font-weight:600; font-size:15px;">Vertrag ansehen →</a></div>
    </div>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin: 24px 0 0;">
      <tr>
        ...
        <td style="vertical-align:middle;">
          ...
          <div style="color:#94a3b8 !important; font-size:13px; margin-top:4px;">Kaufmann Health - Trauma-Heilung beginnt hier</div>
        </td>
      </tr>
    </table>
    ...
    <div style="background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%) !important; background-image: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%) !important; padding:16px 20px; border-radius:12px; border:1px solid rgba(226, 232, 240, 0.8); margin-top:20px;">
      <p style="color:#64748b !important; font-size:14px; margin:0; line-height:1.6;">Antworte gerne direkt auf diese Nachricht, falls du Rückfragen hast.</p>
    </div>
  `;
