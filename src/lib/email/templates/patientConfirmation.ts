...
export function renderPatientConfirmation(params: {
  ...
  const detailsHtml = `
    <div style="background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%) !important; background-image: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%) !important; padding:20px 24px; border-radius:12px; border:1px solid rgba(226, 232, 240, 0.8); margin: 20px 0; box-shadow: 0 2px 4px 0 rgba(100, 116, 139, 0.05);">
      <h3 style="margin:0 0 16px; color:#0f172a !important; font-size:18px; font-weight:700;">Deine Angaben</h3>
      <table role="presentation" cellpadding="0" cellspacing="0" style="font-size:15px; color:#475569 !important; line-height:1.65;">
        <tr><td style="padding:6px 12px 6px 0; width:160px; color:#64748b !important; font-weight:500;">Stadt</td><td style="padding:6px 0; color:#0f172a !important;">${escapeHtml(city || '—')}</td></tr>
        <tr><td style="padding:6px 12px 6px 0; width:160px; color:#64748b !important; font-weight:500;">Anliegen</td><td style="padding:6px 0; color:#0f172a !important;">${escapeHtml(issue || '—')}</td></tr>
        <tr><td style="padding:6px 12px 6px 0; width:160px; color:#64748b !important; font-weight:500;">Sitzungsart</td><td style="padding:6px 0; color:#0f172a !important;">${prefLabel}</td></tr>
      </table>
    </div>
  `;
  ...
  const contentHtml = `
    ...
    <div style="background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%) !important; background-image: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%) !important; padding:16px 20px; border-radius:12px; border:1px solid rgba(226, 232, 240, 0.8); margin-top:20px;">
      <p style="color:#64748b !important; font-size:14px; margin:0; line-height:1.6;">Du kannst jederzeit auf diese Nachricht antworten, falls du Ergänzungen oder Fragen hast.</p>
    </div>
  `;
